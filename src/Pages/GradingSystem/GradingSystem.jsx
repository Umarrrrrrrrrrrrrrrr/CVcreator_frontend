...
import CVReportCard from '../../components/CVReportCard';
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10 mb-16 border-2 border-blue-100">
          ...
          {gradeResult && (
            <div className="mt-8 bg-white rounded-2xl shadow-xl p-6 md:p-8 border-2 border-green-100">
              ...
              {/* CV report dashboard — directly under actions including "Use in Template" */}
              <div className="mt-8 pt-2 border-t border-gray-100">
                <CVReportCard
                  animatedMetrics={animatedMetrics}
                  reportHasData={reportHasData}
                  reportDisplayMetrics={reportDisplayMetrics}
                  reportLetter={reportLetter}
                  reportActiveGrade={reportActiveGrade}
                  reportActiveScore={reportActiveScore}
                  title="Your last CV report"
                  description="Updated from your latest analysis above"
                />
              </div>
            </div>
          )}

          {/* Saved report (e.g. after refresh) — same card when no active result */}
          {!gradeResult && reportHasData && (
            <div className="mt-8">
              <CVReportCard
                animatedMetrics={animatedMetrics}
                reportHasData={reportHasData}
