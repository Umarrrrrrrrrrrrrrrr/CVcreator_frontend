        ...
        <div className="flex justify-between items-center h-20">
          <div className="flex-shrink-0 flex items-center ml-12">
            <button
              type="button"
              onClick={() => navigate("/")}
              className="flex items-center gap-3 rounded-full bg-gray-200/80 px-5 py-2.5 shadow-inner hover:opacity-90 transition-opacity"
            >
              <img
                src={Logo}
                alt="NIRN Logo"
                className="h-8 md:h-10 w-auto max-w-[70px] object-contain"
              />
              <span className="text-2xl md:text-3xl font-bold text-gray-800 tracking-tight">NIRN</span>
            </button>
          </div>
